...
namespace StylizedWater2
{
    public class StylizedWaterEditor : Editor
    {
        ...
        #if SWS_DEV
        [MenuItem("SWS/Install/UnderwaterRenderingInstalled")]
        #endif
        public static bool UnderwaterRenderingInstalled()
        {
            ...
            bool state = AssetDatabase.LoadMainAssetAtPath(path);

            #if SWS_DEV
            Debug.Log("Underwater Rendering installed? " + state);
            #endif
        ...
        #if SWS_DEV
        [MenuItem("SWS/Install/SurfaceModifiersInstalled")]
        #endif
        public static bool SurfaceModifiersInstalled()
        {
            //Checking for WaterModifierRenderer.cs
            string path = AssetDatabase.GUIDToAssetPath("89138902f514ada418b44ddd62e8de22");
            bool state = AssetDatabase.LoadMainAssetAtPath(path);

            #if SWS_DEV
            Debug.Log("Surface Modifiers installed? " + state);
            #endif
